...
const Layout = () => {
  return (
    <div id="wrapper">
      <header>
        <h1>
          <LinkList goto="/">hy 2024 portfolio.</LinkList>
        </h1>
        <nav>
          <ul>
      ...
      <footer>
        <div className="portfolio-links">
          ...
          <ul>
            <li>
              <Link className="btn footer-btn" to="/projects/js/numberGuess">
                Number Guess
              </Link>
            </li>
            <li>
              <Link className="btn footer-btn" to="/projects/js/fakeKeyboard">
                Fake Keyboard
              </Link>
            </li>
            <li>
